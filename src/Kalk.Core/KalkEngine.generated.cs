...
";
            }
            {
                ...
                descriptor.IsCommand = true;
                descriptor.Params.Add(new KalkParamDescriptor("x", @"An original seed value for the `rnd` function.")  { IsOptional = false });
                descriptor.Example = @">>> seed(0); rnd
    # seed(0); rnd
    out = 0.7262432699679598
    >>> seed(1); rnd
...
";
            }
            {
                ...
                descriptor.Category = "Math Functions";
                descriptor.Description = @"Converts x from degrees to radians.";
                descriptor.IsCommand = false;
            }
            {
                var descriptor = Descriptors["degrees"];
                descriptor.Category = "Math Functions";
                descriptor.Description = @"Converts x from radians to degrees.";
                descriptor.IsCommand = false;
            }
            {

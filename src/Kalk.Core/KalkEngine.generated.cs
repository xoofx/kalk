...
";
            ...
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> byte16(1..16)
    # byte16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> byte32(1..32)
    # byte32(1..32)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> byte64(1..64)
    # byte64(1..64)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> sbyte16(1..16)
    # sbyte16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> sbyte32(1..32)
    # sbyte32(1..32)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> sbyte64(1..64)
    # sbyte64(1..64)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> short16(1..16)
    # short16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> short32(1..32)
    # short32(1..32)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> ushort2(1..2)
    # ushort2(1..2)
    out = ushort2(1, 2)
    >>> ushort2(10, 11)
    # ushort2(10, 11)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> ushort4(1..4)
    # ushort4(1..4)
    out = ushort4(1, 2, 3, 4)
    >>> ushort4(10, 11, 12, 13)
    # ushort4(10, 11, 12, 13)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> ushort8(1..8)
    # ushort8(1..8)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> ushort16(1..16)
    # ushort16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> ushort32(1..32)
    # ushort32(1..32)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> uint16(1..16)
    # uint16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> float16(1..16)
    # float16(1..16)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> double2(1..2)
    # double2(1..2)
    out = double2(1, 2)
    >>> double2(10, 11)
    # double2(10, 11)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> double3(1..3)
    # double3(1..3)
    out = double3(1, 2, 3)
    >>> double3(10, 11, 12)
    # double3(10, 11, 12)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> double4(1..4)
    # double4(1..4)
    out = double4(1, 2, 3, 4)
    >>> double4(10, 11, 12, 13)
    # double4(10, 11, 12, 13)
...
";
            }
            {
                ...
                descriptor.IsCommand = false;
                descriptor.Example = @"    >>> double8(1..8)
    # double8(1..8)
